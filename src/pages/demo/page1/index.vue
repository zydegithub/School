  ...
  <el-tabs type="border-card" v-model="activeName">
    ...
    <el-tab-pane label="列表" name="second">
      <el-row>
        <el-col :span="24">
          <!-- 中间动态区 -->
          <div style="height:600px;width:1000px;float:left;background:#F5F7FA">
            <el-scrollbar style="height:100%">
              <!-- 每个动态 -->
              <div
                class="grid-content bg-purple-dark"
                style="margin:0px 0px 10px 0px;border:1px solid black"
              ...
              >
                ...
                <div style="float:right;margin:0px 15px 10px auto;">
                  <a href="#" @click="toggle(item.objectid)">
                    <img
                      style="width:24px;vertical-align:middle"
                  ...
                  <a
                    href="#"
                    @click="like(item.objectid)"
                    v-if="item.likes.indexOf(','+info.name+',')==-1"
                  >
                    <img style="width:24px;vertical-align:middle" src="image/theme/icon/like.png">
                    <span
                      style="font-weight:200;margin-right:20px;margin-left:2px"
                    >{{ item.likecount }}</span>
                  </a>
                  <a href="#" @click="like(item.objectid)" v-else>
                    <img style="width:24px;vertical-align:middle" src="image/theme/icon/liked.png">
                    <span
                      style="font-weight:200;margin-right:20px;margin-left:2px"
                    >{{ item.likecount }}</span>
                  </a>
                ...
                <!-- 好友评论区 -->
                <div
                  style="width:948px;height:100%;margin-bottom:5px;margin-left:24px"
                  v-if="item.play"
                >
                  <hr style="width:100%">
                  <div v-for="comments in item.comments" :key="comments.cid">
                    <div>
                      ...
                      <div style="float:left;margin:2px 8px 2px 6px;">
                        ...
                        <a href="#" @click="commentReply(item.objectid,comments.cid)">
                          <img
                    ...
                    <!-- 好友回复区 -->
                    <div v-for="(reply,index) in find(item.objectid,comments.id)" :key="index">
                      <div
                        style="width:948px;height:100%;margin-bottom:5px;margin-left:24px;clear:both"
                      >
                        <div>
                          <div style="float:left">
                            <img
                          ...
                          <div style="float:left;margin:2px 8px 2px 6px;">
                            ...
                            <a href="#" @click="replyReply(reply.objectid,reply.id)">
                              <img
                                style="width:20px;vertical-align:middle;margin-left:10px"
                                src="image/theme/icon/message.png"
                              >
                ...
                <!-- 评论框 -->
                <el-input v-model="item.input" placeholder="评论:" style="width:926px"></el-input>
                <el-button @click="sent(item.objectid)">发送</el-button>
              </div>
            </el-scrollbar>
          </div>
          ...
          <!-- 侧边栏 -->
          <div
            style="height:580px;width:300px;border:1px solid black;float:right;background:#F5F7FA;border-radius:5px;"
          >
            ...
            <!-- <hr style="background-color:#D9D9D9;height: 1px;width:100%;border: none;"> -->
            <div
            ...
            >
              <div style="float:left">
                <a style="margin-left:16px;font-size:14px" :href="mao2(item.objectid)" title="查看">
...
import indexVue from "../page2/index.vue";
Vue.use(Viewer);
Viewer.setDefaults({
  Options: {
    inline: true,
    ...
    init() {
      ...
      esriLoader
        .loadModules(this.gisModules, {
          url: "http://localhost/arcgis_js_api/library/3.17/3.17/init.js"
        })
